...
//
//
//    IVRInstanceManager instance_creator;
//    Instance_ = instance_creator.CreateVulkanInstance();
//
//    createSurface();
//
//    IVRDeviceManager device_creator;
//    device_creator.PickPhysicalDevice(Surface_, Instance_);
//    device_creator.CreateLogicalDevice(Surface_);
//
//    PhysicalDevice_ = device_creator.GetPhysicalDevice();
//    LogicalDevice_ = device_creator.GetLogicalDevice();
...
//
//    SwapchainManager_ = std::make_shared<IVRSwapchainManager>(); //build will fail because of this line (swapchain creation requires device manager and window)
...
//    UniformBufferManager_->CreateUniformBuffer();
//
...
//    pipeline_config.VertexShaderPath = IVRPath::GetCrossPlatformPath({ "shaders", "vert.spv" });
//    pipeline_config.FragmentShaderPath = IVRPath::GetCrossPlatformPath({ "shaders", "frag.spv" });
//
//    PipelineManager_ = std::make_shared<IVRPipelineManager>(LogicalDevice_, SwapchainManager_, UniformBufferManager_, sample_texture, depth_image, pipeline_config);
//    GraphicsPipeline_ = PipelineManager_->CreateGraphicsPipeline();
//    RenderPass_ = PipelineManager_->GetRenderPass();
//    SwapchainManager_->CreateFramebuffers(RenderPass_, depth_image->GetDepthImageView());
//    
...
//
//    SwapchainManager_->DestroySwapchain();

...
//{
//    VkShaderModule vert_shader_module = CreateShaderModule(VertexShaderCode_);
//    VkShaderModule frag_shader_module = CreateShaderModule(FragmentShaderCode_);
//
...
//    depth_stencil_state.depthCompareOp = VK_COMPARE_OP_LESS; //specifies lower depth = closer
//    depth_stencil_state.depthBoundsTestEnable = VK_FALSE; //allows to keep fragments that are within a certain range of the depth buffer
//    depth_stencil_state.minDepthBounds = 0.0f;
//    depth_stencil_state.maxDepthBounds = 1.0f;
//    //following three properties are used for stencil testing / stencil buffer operations
...
//    //                                      the VkSubpassDescription struct which will be defined later)
...
//    subpass.pDepthStencilAttachment = &depth_attachment_ref; //subpass can only use a single depth + stencil attachment
//
...
//
//    std::array<VkDescriptorPoolSize, 2> descriptor_pool_sizes{}; //need one pool size struct for each type of descriptor (specify the type and the number of descriptors of that type)
//
...
//}
//
//void IVRPipelineManager::ReadShaderFiles()
//{
//    VertexShaderCode_ = SimpleFileReader::ReadFile(PipelineConfig_.VertexShaderPath.c_str());
//    FragmentShaderCode_ = SimpleFileReader::ReadFile(PipelineConfig_.FragmentShaderPath.c_str());
//}
//
//
